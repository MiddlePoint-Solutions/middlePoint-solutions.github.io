...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const isInvalidPair = (color1, color2) => {
        return invalidPairs.some(pair => (pair[0].toUpperCase() === color1.toUpperCase() && pair[1].toUpperCase() === color2.toUpperCase()) ||
    ...
    const getRandomColor = (currentColor, pairWithColor) => {
        let newColor;
        let attempts = 0;
